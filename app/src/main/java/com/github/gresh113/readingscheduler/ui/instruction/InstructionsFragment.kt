...
package com.github.gresh113.readingscheduler.ui.instruction
...
class InstructionsFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    val preferenceRepository = (requireActivity().application as ReadingScheduler).preferenceRepository
